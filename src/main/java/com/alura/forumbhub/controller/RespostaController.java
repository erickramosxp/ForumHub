...
public class RespostaController {
    ...
    @PostMapping
    @Transactional
    public void registrarResposta(@PathVariable String id, @RequestBody DadosRegistoResposta dados) {
        var topico = topicoRepository.getReferenceById(Long.parseLong(id));
